...
const AddHabitModal = ({ onClose, onAdd }) => {
  ...
  const [dailyTarget, setDailyTarget] = useState(5); // Now represents days/week based on the UI screenshot
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#12161F] text-white p-4 rounded-xl border-2 border-[#1F2937] focus:outline-none focus:border-[#34D399] transition-all placeholder:text-[#4B5563] shadow-[0_0_0_transparent] focus:shadow-[0_0_15px_rgba(52,211,153,0.15)]"
              value={name}
          ...
          <div className="flex justify-end items-center gap-4 mt-2">
            ...
            <button 
              type="submit" 
              className="bg-[#6EE7B7] hover:bg-[#34D399] text-[#042F2E] px-6 py-2.5 rounded-lg font-semibold transition-all shadow-[0_0_15px_rgba(110,231,183,0.3)] transform active:scale-95"
            >
              Create
            </button>
          </div>
